  ...
  render() {
    ...
    return (
      <div style={styles}>
        ...
        <div>
          <span>Year:</span>
          <input name='year' type='number' value={this.state.year} onChange={this.handleInputChange}></input>
        </div>
        <div>
          <span>Team Size Cap:</span>
          <input name='team_size_cap' type='number' value={this.state.team_size_cap} onChange={this.handleInputChange}></input>
        </div>
        <div>
          <span>Admins:</span><span>using last year</span>
        </div>
